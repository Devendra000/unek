  ...
  return (
    <Link href={`/trend/${categoryId}/${trend.id}`}>
      <motion.div
        ...
        className="group relative overflow-hidden rounded-xl border border-border bg-card cursor-pointer transition-all duration-150 hover:border-primary hover:shadow-lg"
      >
        {/* Fixed Image Section */}
